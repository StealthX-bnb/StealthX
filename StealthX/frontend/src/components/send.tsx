...
export function Send() {
  ...
  return (
    <div style={{ paddingTop: '1rem' }}>
      ...
      The user who owns the StealthX will have control over the secret account.
      </p>
      <form
        className="lane"
        onSubmit={() => {
      ...
      >
        <div className="input-container">
          <input
            ...
            spellCheck="false"
            autoComplete="off"
            placeholder="Enter receiver StealthX"
            onChange={handleIDInput}
          />
          <label htmlFor="xcryptID">StealthX</label>
        </div>
      </form>
      ...
      {isConnected && balance && (
        <>
          ...
          {xcryptIDError && (
            <div className="lane">
              <p className="message error">Invalid StealthX</p>
            </div>
          )}
